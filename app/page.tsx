...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      <h1 className="text-[68px] relative font-light text-white -mt-0 z-[2] sm:text-center">
        Connect  friends {' '}
        <span className="font-semibold">easily</span> & {' '}
        <span className="font-semibold">quickly</span>
      </h1>
      <p className="text-gray-400  sm:text-center font-medium text-sm">
      ...
      <Link
        href="/sign-in"
        className="text-[#bebebe] text-center block font-light my-7"
      >
